...
class ContactsViewModel @Inject constructor(
    ...
    // To observe value in ContactsFragment
    val whatsAppContactsList: StateFlow<List<User>> = _whatsAppContactsList

    private lateinit var iContactsViews : IContactsView
        ...
        viewModelScope.launch {
            ...
            contactsUseCase.getAllUsers(deviceContacts).collectLatest {
                when(it) {
                    ...
                    is Resource.Error -> {
                        iContactsViews.showError(it.message?:"An Error Occurred in ContactsViewModel::getAllWhatsAppContacts()")
                    }
                }
            }
        }
